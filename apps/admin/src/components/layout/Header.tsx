    ...
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-100 bg-white/80 px-6 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4">
        <Button
          ...
          size="icon"
          onClick={toggleLang}
          className="rounded-xl text-slate-600 transition-all hover:bg-primary/5 hover:text-primary"
        >
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="flex flex-col items-start gap-0.5 pe-2">
                <span className="text-sm font-bold leading-none text-slate-800">Admin</span>
                <span className="text-[10px] font-bold uppercase leading-none tracking-tight text-slate-600">
