    ...
    <div className="page-container">
      ...
      <div className="page-content">
        <div className="page-content-inner">
          ...
          <Card style={{ marginBottom: 24 }}>
            <Space wrap size="middle" style={{ width: '100%', justifyContent: 'space-between' }}>
              <Space wrap>
                ...
                <Select allowClear size="large" style={{ width: 170 }} placeholder="حالة الحجز" value={status} onChange={setStatus} options={[{ value: 'active', label: 'نشط' }, { value: 'completed', label: 'مكتمل' }, { value: 'cancelled', label: 'ملغي' }]} />
          ...
          <Card>
            <Table<OfferBookingRow> rowKey="id" loading={loading} dataSource={rows} columns={columns as any} locale={{ emptyText: <Empty description="لا توجد حجوزات عروض حالياً" /> }} pagination={{ pageSize: 10, showSizeChanger: true }} scroll={{ x: 900 }} />
          </Card>
        </div>
      </div>
    </div>
